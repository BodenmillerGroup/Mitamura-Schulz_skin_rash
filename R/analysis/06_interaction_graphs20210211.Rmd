...
```{r path to data}
fn_cells <- "~/bbvolume/Data/Skin_rash//processed/cpout/cell.csv"

fn_relationship <- "~/bbvolume/Data/Skin_rash/processed/cpout/Object relationships.csv"
```
...
pdf("~/bbvolume/Data/Skin_rash/Rout/plots/chordDiagram_all_samples.pdf",width = 20,height = 20)
...
pdf("~/bbvolume/Data/Skin_rash/Rout/plots/chordDiagram_by_indication.pdf",width = 20,height =5.5)
...
```{r, fig.height=6, fig.width=25}
pdf("~/bbvolume/Data/Skin_rash/Rout/plots/chordDiagram_by_indication_all_celltypes.pdf",width = 20,height =5.5)
...
pdf("~/bbvolume/Data/Skin_rash/Rout/plots/chordDiagram_by_indication_no_outliers.pdf",width = 20,height =5.5)
