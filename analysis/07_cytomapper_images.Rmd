...
for(i in 1:16){
png(paste0("~/bbvolume/Data/Dermatology/covid_skin_rash/Rout/cytomapper_images/celltypes_per_image_noscale_no_name_",i,".png"), width = 2500, height = 2500)
